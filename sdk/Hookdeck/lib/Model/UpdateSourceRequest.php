...
/**
 * UpdateSourceRequest Class Doc Comment
 *
 * @category Class
 * @package  Hookdeck
 * @author   OpenAPI Generator team
 ...
 */
class UpdateSourceRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'updateSource_request';
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name A unique name for the source
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 155)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UpdateSourceRequest., must be smaller than or equal to 155.');
        }
        if ((!preg_match("/^[A-z0-9-_]+$/", ObjectSerializer::toString($name)))) {
            throw new \InvalidArgumentException("invalid value for \$name when calling UpdateSourceRequest., must conform to the pattern /^[A-z0-9-_]+$/.");
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 500)) {
            throw new \InvalidArgumentException('invalid length for $description when calling UpdateSourceRequest., must be smaller than or equal to 500.');
        }
