...
/**
 * UpsertConnectionRequestSource Class Doc Comment
 *
 * @category Class
 ...
 */
class UpsertConnectionRequestSource implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'upsertConnection_request_source';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 155)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UpsertConnectionRequestSource., must be smaller than or equal to 155.');
        }
        if ((!preg_match("/^[A-z0-9-_]+$/", ObjectSerializer::toString($name)))) {
            throw new \InvalidArgumentException("invalid value for \$name when calling UpsertConnectionRequestSource., must conform to the pattern /^[A-z0-9-_]+$/.");
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 500)) {
            throw new \InvalidArgumentException('invalid length for $description when calling UpsertConnectionRequestSource., must be smaller than or equal to 500.');
        }
