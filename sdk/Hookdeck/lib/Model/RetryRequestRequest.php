...
/**
 * RetryRequestRequest Class Doc Comment
 *
 * @category Class
 * @package  Hookdeck
 * @author   OpenAPI Generator team
 ...
 */
class RetryRequestRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'retryRequest_request';
    ...
    */
     ...
     * Sets webhook_ids
     *
     * @param string[] $webhook_ids Subset of webhook_ids to re-run the event logic on. Useful to retry only specific ignored_events
     *
     * @return self
     */
