<?php
/**
 * GetEventBulkRetriesQueryParameter
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * GetEventBulkRetriesQueryParameter Class Doc Comment
 *
 * @category Class
 ...
 */
class GetEventBulkRetriesQueryParameter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getEventBulkRetries_query_parameter';
    ...
    */
    ...
    public function setSearchTerm($search_term)
    {
        ...
        if ((mb_strlen($search_term) < 3)) {
            throw new \InvalidArgumentException('invalid length for $search_term when calling GetEventBulkRetriesQueryParameter., must be bigger than or equal to 3.');
        }
