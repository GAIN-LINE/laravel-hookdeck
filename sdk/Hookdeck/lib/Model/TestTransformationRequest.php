...
/**
 * TestTransformationRequest Class Doc Comment
 *
 * @category Class
 * @package  Hookdeck
 * @author   OpenAPI Generator team
 ...
 */
class TestTransformationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'testTransformation_request';
    ...
    protected static $openAPITypes = [
        ...
        'request' => '\Hookdeck\Model\TestTransformationRequestRequest',
        'event_id' => 'string'
    ];
    ...
    */
     ...
     * Sets webhook_id
     *
     * @param string|null $webhook_id ID of the connection to use for the execution `context`
     *
     * @return self
     */
     ...
     *
     * @param string|null $transformation_id Transformation ID
     *
     * @return self
     */
     ...
     * Gets request
     *
     * @return \Hookdeck\Model\TestTransformationRequestRequest|null
     */
     ...
     * Sets request
     *
     * @param \Hookdeck\Model\TestTransformationRequestRequest|null $request request
     *
     * @return self
     */
