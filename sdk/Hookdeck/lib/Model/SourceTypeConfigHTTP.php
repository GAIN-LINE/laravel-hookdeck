...
/**
 * SourceTypeConfigHTTP Class Doc Comment
 *
 * @category Class
 ...
 */
class SourceTypeConfigHTTP implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SourceTypeConfigHTTP';
    ...
    protected static $openAPITypes = [
        ...
        'auth_type' => 'string',
        'auth' => '\Hookdeck\Model\SourceConfigHTTPAuth'
    ];
    ...
    */
    ...
    public function setAllowedHttpMethods($allowed_http_methods)
    {
        ...
        if ((count($allowed_http_methods) < 1)) {
            throw new \InvalidArgumentException('invalid length for $allowed_http_methods when calling SourceTypeConfigHTTP., number of items must be greater than or equal to 1.');
        }
     ...
     * Gets auth
     *
     * @return \Hookdeck\Model\SourceConfigHTTPAuth|null
     */
     ...
     * Sets auth
     *
     * @param \Hookdeck\Model\SourceConfigHTTPAuth|null $auth auth
     *
     * @return self
     */
