...
/**
 * SourceTypeConfig Class Doc Comment
 *
 * @category Class
 ...
 */
class SourceTypeConfig implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SourceTypeConfig';
    ...
    */
    ...
    public function setAllowedHttpMethods($allowed_http_methods)
    {
        ...
        if ((count($allowed_http_methods) < 1)) {
            throw new \InvalidArgumentException('invalid length for $allowed_http_methods when calling SourceTypeConfig., number of items must be greater than or equal to 1.');
        }
